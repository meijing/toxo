...
class TextosControllerTest < ActionController::TestCase
  ...
  test "should create texto" do
    assert_difference('Texto.count') do
      post :create, texto: { description: @texto.description, image: @texto.image, second_image: @texto.second_image }
    end
  ...
  test "should update texto" do
    patch :update, id: @texto, texto: { description: @texto.description, image: @texto.image, second_image: @texto.second_image }
    assert_redirected_to texto_path(assigns(:texto))
  end
